...
namespace WearAndShare.App_Start
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundle)
        {
            ...
            bundle.Add(new ScriptBundle("~/bundle/icons/font-awesome/webfonts/fa-solid-900.ttf").Include(
                                "~/Areas/Admin/Content/css/icons/font-awesome/webfonts/fontawesome-webfont.ttf"
            ));
        }
